...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<div class="row">
		<?php echo $form->labelEx($model,'siebel_name'); ?>
		<?php echo $form->textField($model,'siebel_name',array('size'=>60,'maxlength'=>250)); ?>
		<?php echo $form->error($model,'siebel_name'); ?>
	</div>
